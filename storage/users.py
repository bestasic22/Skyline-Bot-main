...
_store = CollectionStore(
    ...
    defaults={'balance': 0, 'level': 0, 'xp': 0, 'transfered_balance': 0, 'received_balance': 0, 'economy_rules_accepted': False, 'type': 'user', 'relationship': 'single', 'birthday_day': 0, 'birthday_month': 0, 'birthday_year': 0, 'birthday_notify_enabled': True, 'no_prefix': False, 'no_prefix_subscription': False, 'banned': False, 'updated_at': NOW, 'created_at': NOW},
    unique_sets=[['user_id']],
    json_fields=set([]),
...
async def insert(
    ...
    birthday_notify_enabled:bool=None,
    no_prefix:bool=None,
