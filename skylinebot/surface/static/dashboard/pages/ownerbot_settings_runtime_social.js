(() => {
  ...
  const parseSeedJson = (elementId, fallback) => {
  ...
  const seedSocialRows = parseSeedJson('ownerbotSocialRowsSeed', []);
  const socialPlatformKeys = parseSeedJson('ownerbotSocialPlatformKeysSeed', []);
  const socialPlatformLabels = parseSeedJson('ownerbotSocialPlatformLabelsSeed', {});
  const socialPlatformIcons = parseSeedJson('ownerbotSocialPlatformIconsSeed', {});
