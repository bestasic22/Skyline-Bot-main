...
from storage import ai_chat_channels as ai_chat_channels_db
from storage import image_ocr_settings as image_ocr_settings_db
from storage import server_stats as server_stats_db
from storage import donate_settings as donate_settings_db
...
class Guilds:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Guilds cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.guilds:
            ...
            logger.database(f"Guild - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Guild - {guild_id} cache updated ✅")
...
class Users:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Users cache loaded ✅")
    ...
    async def delete(self, user_id):
        ...
        if str(user_id) in cache.users:
            ...
            logger.database(f"User - {user_id} cache deleted ✅")
    ...
    async def update(self, user_id, data=None):
        ...
        logger.database(f"User - {user_id} cache updated ✅")
...
class Guilds_log:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Guilds log cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.guilds_log:
            ...
            logger.database(f"Guild - {guild_id} log cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Guild - {guild_id} log cache updated ✅")
...
class Antinuke_settings:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Antinuke settings cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.antinuke_settings:
            ...
            logger.database(f"Antinuke settings - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Antinuke settings - {guild_id} cache updated ✅")
...
class antinuke_bypass:
    ...
    async def delete(self, guild_id, user_id):
        ...
        if str(guild_id) in cache.antinuke_bypass:
            ...
            if str(user_id) in cache.antinuke_bypass[str(guild_id)]:
                ...
                logger.database(f"Antinuke bypass - {guild_id} - {user_id} cache deleted ✅")
    ...
    async def update(self, guild_id, user_id, data=None):
        ...
        logger.database(f"Antinuke bypass - {guild_id} - {user_id} cache updated ✅")
...
class Guilds_welcomer:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Welcomer settings cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.welcomer_settings:
            ...
            logger.database(f"Welcomer settings - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Welcomer settings - {guild_id} cache updated ✅")
...
class Guilds_Backup:
        ...
        if str(guild_id) in cache.guilds_backup:
            ...
            for backup in cache.guilds_backup[str(guild_id)]:
                ...
                if backup['id'] == id:
                    ...
                    logger.database(f"Guild - {guild_id} backup - {id} cache deleted ✅")
    ...
    async def update(self, guild_id, data):
        ...
        logger.database(f"Guild - {guild_id} backup cache updated ✅")
...
class Redeem_codes:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Redeem codes cache loaded ✅")
    ...
    async def delete(self, code):
        ...
        if str(code) in cache.redeem_codes:
            ...
            logger.database(f"Redeem code - {code} cache deleted ✅")
    ...
    async def update(self, code, data=None):
        ...
        logger.database(f"Redeem code - {code} cache updated ✅")
...
class Afk:
        ...
        if guild_id:
            ...
            if str(guild_id) in cache.afk.get('guilds', {}):
                ...
                if str(user_id) in cache.afk['guilds'][str(guild_id)]:
                    ...
                    logger.database(f"AFK - {guild_id} - {user_id} cache deleted ✅")
            ...
            if str(user_id) in cache.afk.get('global', {}):
                ...
                logger.database(f"AFK - {user_id} cache deleted ✅")
    ...
    async def update(self, guild_id, user_id, data=None):
        ...
        if guild_id:
            ...
            logger.database(f"Afk - {guild_id} - {user_id} cache updated ✅")

        else:

            cache.afk['global'][str(user_id)] = data

            logger.database(f"Afk - {user_id} cache updated ✅")
...
class SnipeData:
    ...
    async def initialize(self):
        ...
        logger.database(f"All Snipe data cache loaded ✅")
        ...
        if type == 'delete':
            ...
            if 'delete' in cache.snipe_data:
                ...
                if str(channel_id) in cache.snipe_data['delete']:
                    ...
                    logger.database(f"Snipe delete - {channel_id} cache deleted ✅")
            ...
            if 'edit' in cache.snipe_data:
                ...
                if str(channel_id) in cache.snipe_data['edit']:
                    ...
                    logger.database(f"Snipe edit - {channel_id} cache deleted ✅")
    ...
    async def update(self, channel_id, type=None, data=None):
        ...
        if type == 'delete':
            ...
            logger.database(f"Snipe delete - {channel_id} cache updated ✅")
            ...
            logger.database(f"Snipe edit - {channel_id} cache updated ✅")
...
class IgnoreData:
    ...
    def __init__(self):
        ...
        logger.database(f"All Ignore data cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Ignore data cache loaded ✅")
    ...
    async def delete(self, guild_id, user_id=None, channel_id=None):
        ...
        if user_id:
            ...
            if str(user_id) in cache.ignore_data['users'].get(str(guild_id), {}):
                ...
                logger.database(f"Ignore user - {user_id} cache deleted ✅")
            ...
            if str(channel_id) in cache.ignore_data['channels'].get(str(guild_id), {}):
                ...
                logger.database(f"Ignore channel - {channel_id} cache deleted ✅")
    ...
    async def update(self, guild_id, user_id=None, channel_id=None, data=None):
        ...
        if user_id:
            ...
            logger.database(f"Ignore user - {user_id} cache updated ✅")
            ...
            logger.database(f"Ignore channel - {channel_id} cache updated ✅")
...
class BanData:
    ...
    def __init__(self):
        ...
        logger.database(f"All Ban data cache initialized ✅")
    ...
    async def delete(self, guild_id=None, user_id=None):
        ...
        if user_id:
            ...
            if str(user_id) in cache.ban_data['users']:
                ...
                logger.database(f"Ban user - {user_id} cache deleted ✅")
            ...
            if str(guild_id) in cache.ban_data['guilds']:
                ...
                logger.database(f"Ban guild - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id=None, user_id=None, data=None):
        ...
        if user_id:
            ...
            logger.database(f"Ban user - {user_id} cache updated ✅")

        elif guild_id:

            cache.ban_data['guilds'][str(guild_id)] = data

            logger.database(f"Ban guild - {guild_id} cache updated ✅")
...
class Automod:
    ...
    def __init__(self):
        ...
        logger.database(f"All Automod cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Automod cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.automod:
            ...
            logger.database(f"Automod - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Automod - {guild_id} cache updated ✅")
...
class CustomRoles:
    ...
    def __init__(self):
        ...
        logger.database(f"All Custom roles cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Custom roles cache loaded ✅")
    ...
    async def delete(self, guild_id, name):
        ...
        if str(guild_id) in cache.custom_roles:
            ...
            if str(name) in cache.custom_roles[str(guild_id)]:
                ...
                logger.database(f"Custom role - {guild_id} - {name} cache deleted ✅")
    ...
    async def update(self, guild_id, name, data=None):
        ...
        logger.database(f"Custom role - {guild_id} - {name} cache updated ✅")
...
class CustomRolesPermissions:
    ...
    def __init__(self):
        ...
        logger.database(f"All Custom roles permissions cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Custom roles permissions cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.custom_roles_permissions:
            ...
            logger.database(f"Custom role permission - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Custom role permission - {guild_id} cache updated ✅")
...
class MediaChannels:
    ...
    def __init__(self):
        ...
        logger.database(f"All Media channels cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Media channels cache loaded ✅")
    ...
    async def delete(self, guild_id, channel_id):
        ...
        if str(guild_id) in cache.media_channels:
            ...
            if str(channel_id) in cache.media_channels[str(guild_id)]:
                ...
                logger.database(f"Media channel - {guild_id} - {channel_id} cache deleted ✅")
    ...
    async def update(self, guild_id, channel_id, data=None):
        ...
        logger.database(f"Media channel - {guild_id} - {channel_id} cache updated ✅")
...
class AutoResponder:
    ...
    def __init__(self):
        ...
        logger.database(f"All Auto responder cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Auto responder cache loaded ✅")
    ...
    async def delete(self, guild_id, keyword):
        ...
        if str(guild_id) in cache.auto_responder:
            ...
            if str(keyword) in cache.auto_responder[str(guild_id)]:
                ...
                logger.database(f"Auto responder - {guild_id} - {keyword} cache deleted ✅")
    ...
    async def update(self, guild_id, keyword, data=None):
        ...
        logger.database(f"Auto responder - {guild_id} - {keyword} cache updated ✅")
...
class Giveaways:
    ...
    def __init__(self):
        ...
        logger.database(f"All Giveaways cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Giveaways cache loaded ✅")
    ...
    async def delete(self, guild_id, giveaway_id):
        ...
        if str(guild_id) in cache.giveaways:
            ...
            if str(giveaway_id) in cache.giveaways[str(guild_id)]:
                ...
                logger.database(f"Giveaway - {guild_id} - {giveaway_id} cache deleted ✅")
    ...
    async def update(self, guild_id, giveaway_id, data=None):
        ...
        if data.get('ended'):
            ...
            return logger.info(
                f"Giveaway - {guild_id} - {giveaway_id} already ended (cache update skipped)"
            )
        ...
        logger.database(f"Giveaway - {guild_id} - {giveaway_id} cache updated ✅")
...
class GiveawaysPermissions:
    ...
    def __init__(self):
        ...
        logger.database(f"All Giveaways permissions cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Giveaways permissions cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.giveaways_permissions:
            ...
            logger.database(f"Giveaway permission - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Giveaway permission - {guild_id} cache updated ✅")
...
class TicketSettings:
    ...
    def __init__(self):
        ...
        logger.database(f"All Ticket settings cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Ticket settings cache loaded ✅")
    ...
    async def delete(self, guild_id, ticket_module_id):
        ...
        if str(guild_id) in cache.ticket_settings:
            ...
            if str(ticket_module_id) in cache.ticket_settings[str(guild_id)]:
                ...
                logger.database(f"Ticket settings - {guild_id} - {ticket_module_id} cache deleted ✅")
    ...
    async def update(self, guild_id, ticket_module_id, data=None):
        ...
        logger.database(f"Ticket settings - {guild_id} - {ticket_module_id} cache updated ✅")
...
class Shop:
    ...
    def __init__(self):
        ...
        logger.database(f"All Shop cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Shop cache loaded ✅")
    ...
    async def delete(self, id: int):
        ...
        if str(id) in cache.shop:
            ...
            logger.database(f"Shop - {id} cache deleted ✅")
    ...
    async def update(self, id, data=None):
        ...
        logger.database(f"Shop - {id} cache updated ✅")
...
class Music:
    ...
    def __init__(self):
        ...
        logger.database(f"All Music cache initialized ✅")
    ...
    async def initialize(self):
        ...
        logger.database(f"All Music cache loaded ✅")
    ...
    async def delete(self, guild_id):
        ...
        if str(guild_id) in cache.music:
            ...
            logger.database(f"Music - {guild_id} cache deleted ✅")
    ...
    async def update(self, guild_id, data=None):
        ...
        logger.database(f"Music - {guild_id} cache updated ✅")

class AIChatChannels:

    def __init__(self):

        cache.ai_chat_channels = {}

        logger.database("All AI Chat Channels cache initialized")

    async def initialize(self):

        cache.ai_chat_channels = {}

        ai_channel_rows = await ai_chat_channels_db.get_all()

        for data in ai_channel_rows:

            if data.get("guild_id"):

                cache.ai_chat_channels[str(data["guild_id"])] = data

        logger.database("All AI Chat Channels cache loaded")

    async def delete(self, guild_id):

        if str(guild_id) in cache.ai_chat_channels:

            del cache.ai_chat_channels[str(guild_id)]

            logger.database(f"AI Chat Channels - {guild_id} cache deleted")

        else:

            logger.error(f"AI Chat Channels - {guild_id} cache not found")

    async def update(self, guild_id, data=None):

        if not data:

            data = await ai_chat_channels_db.get(guild_id=guild_id)
        ...
        cache.ai_chat_channels[str(guild_id)] = data

        logger.database(f"AI Chat Channels - {guild_id} cache updated")

class ImageOcr:
    def __init__(self):
        cache.image_ocr_cache = {}
    async def initialize(self):
        cache.image_ocr_cache = {}
        ocr_datas = await image_ocr_settings_db.get_all()
        for data in ocr_datas:
            guild_id = data.get('guild_id')
            if not guild_id:
                continue
            row = dict(data)
            if 'required_image_count' in row and 'image_count' not in row:
                row['image_count'] = row['required_image_count']
            cache.image_ocr_cache[str(guild_id)] = row
        logger.database(f"All Image OCR cache loaded ✅")
    async def delete(self, guild_id):
        if str(guild_id) in cache.image_ocr_cache:
            del cache.image_ocr_cache[str(guild_id)]
            logger.database(f"Image OCR - {guild_id} cache deleted ✅")
        else:
            logger.error(f"Image OCR - {guild_id} cache not found ❌")
    async def update(self, guild_id, data=None):
        if not data:
            data = await image_ocr_settings_db.get(guild_id=guild_id)
        if not data:
            logger.error(f"Image OCR - {guild_id} cache not found ❌")
            return
        cache.image_ocr_cache[str(guild_id)] = data
        logger.database(f"Image OCR - {guild_id} cache updated ✅")

class ServerStats:

    def __init__(self):

        cache.server_stats_cache = {}

    async def initialize(self):

        cache.server_stats_cache = {}

        stats_datas = await server_stats_db.get_all()

        for data in stats_datas:

            cache.server_stats_cache[str(data['guild_id'])] = data

        logger.database(f"All Server Stats cache loaded ✅")

    async def delete(self, guild_id):

        if str(guild_id) in cache.server_stats_cache:

            del cache.server_stats_cache[str(guild_id)]

            logger.database(f"Server Stats - {guild_id} cache deleted ✅")

        else:

            logger.error(f"Server Stats - {guild_id} cache not found ❌")

    async def update(self, guild_id, data=None):

        if not data:

            data = await server_stats_db.get(guild_id=guild_id)
        ...
        cache.server_stats_cache[str(guild_id)] = data

        logger.database(f"Server Stats - {guild_id} cache updated ✅")

class DonateSettings:

    def __init__(self):

        cache.donate_settings_cache = {}

    async def initialize(self):

        cache.donate_settings_cache = {}

        datas = await donate_settings_db.get_all()

        for data in datas:

            cache.donate_settings_cache[str(data['guild_id'])] = data

        logger.database(f"All Donate Settings cache loaded ✅")

    async def delete(self, guild_id):

        if str(guild_id) in cache.donate_settings_cache:

            del cache.donate_settings_cache[str(guild_id)]

            logger.database(f"Donate Settings - {guild_id} cache deleted ✅")

    async def update(self, guild_id, data=None):

        if not data:

            data = await donate_settings_db.get(guild_id=guild_id)

        if not data:

            return

        cache.donate_settings_cache[str(guild_id)] = data

        logger.database(f"Donate Settings - {guild_id} cache updated ✅")
...
ai_chat_channels_cache = AIChatChannels()

command_access_cache = CommandAccess()

image_ocr_cache = ImageOcr()

server_stats_cache = ServerStats()

donate_settings_cache = DonateSettings()
...
async def load_cache():
    ...
    tasks = [
        ...
        ai_chat_channels_cache.initialize(),

        command_access_cache.initialize(),
        image_ocr_cache.initialize(),
        server_stats_cache.initialize(),
        donate_settings_cache.initialize()

    ]

    await asyncio.gather(*tasks)

    logger.success("All cache systems synchronized! ✅")
